...
@Component
class CreateUnreadResourceUseCase :
    AbstractUseCase<CreateUnreadResourceUseCase.InputData, CreateUnreadResourceUseCase.OutputData>() {
    ...
    override fun doAction(input: InputData): OutputData {
        ...
        resourceService.createUnreadResource(store, path, resource)
